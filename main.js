...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://battleship_2022/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://battleship_2022/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://battleship_2022/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://battleship_2022/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ \"./src/app.js\");\n/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM */ \"./src/DOM.js\");\n\n\n\n//once new game btn is clicked, run gameLoop\n//create\nconst gameLoop = () => {\n    const createDOM = () => {\n        const htmlDOM = (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.DOM)();\n    }\n\n    const createPlayer = (name) => {\n        const p = (0,_app__WEBPACK_IMPORTED_MODULE_0__.Player)(`${name}`);\n    }\n    const createComputer = () => {\n        const c = (0,_app__WEBPACK_IMPORTED_MODULE_0__.Player)('computer');\n    }\n\n    const createGB = (n) => {\n        let gb = (0,_app__WEBPACK_IMPORTED_MODULE_0__.Gameboard)(n);\n    }\n\n    const createP = (n) => {\n        let p = (0,_app__WEBPACK_IMPORTED_MODULE_0__.Player)(`${n}`);\n        return () => {\n            let gb = (0,_app__WEBPACK_IMPORTED_MODULE_0__.Gameboard)(p)\n            return gb;        \n        }\n    }\n    let player = createPlayer('zamir');\n    let playerGB = createGB('zamir');\n\n    // let p = createP('zamir');\n    // let returnedP = p();\n    // let curryingGB = createP('zamir')();\n\n\n\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gameLoop);\n\n//# sourceURL=webpack://battleship_2022/./src/game.js?");
